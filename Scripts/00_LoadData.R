...
opt<-list(mainPath="D:/DATA/WORK/Toro.et.al.MyPROSLE.2022",
          dataPath="D:/DATA/WORK/Toro.et.al.MyPROSLE.2022/Datasets",
          scriptPath="D:/DATA/WORK/Toro.et.al.MyPROSLE.2022/Scripts",
          database="tmod") 

set.seed(123456788)
source(paste0(opt$scriptPath,"/Resources.R",sep=""))

load.libraries(set="00")
...
# Total: nºSLE (3048), nºH (697), hay que sumar los del tabalumab
# dataset1: nºSLE (924), nºH (72)
# dataset2: nºSLE (292), nºH (20)
# dataset3: nºSLE (79), nºH (30)
# dataset4: nºSLE (99), nºH (18)
# dataset5: nºSLE (325), nºH (187)
# dataset6: nºSLE (82), nºH (77)
# dataset7: nºSLE (144), nºH (10)
# dataset8: nºSLE (376), nºH (263)
# dataset9: nºSLE (727), nºH (20)
